...
function Y(d: number[], _: number){
	d[_ >> 5] |= 128 << _ % 32;
	d[14 + (_ + 64 >>> 9 << 4)] = _;
	let m = 1732584193, f = -271733879, r = -1732584194, i = 271733878, n = 0;
	for(; n < d.length; n += 16){
		let h = m, t = f, g = r, e = i;
		f = md5_ii(
			f = md5_ii(
												...
												f = md5_gg(
													f = md5_gg(
														f = md5_ff(
															...
															r, i = md5_gg(
																i, m = md5_gg(m, f, r, i, d[n + 1], 5, -165796510),
																f, r, d[n + 6], 9, -1069501632,
															), m, f, d[n + 11], 14, 643717713,
														), i, m, d[n], 20, -373897302,
													), r = md5_gg(
														r, i = md5_gg(
															i, m = md5_gg(m, f, r, i, d[n + 5], 5, -701558691), f, r,
															d[n + 10], 9, 38016083,
														), m, f, d[n + 15], 14, -660478335,
													), i, m, d[n + 4], 20, -405537848,
												), r = md5_gg(
													r, i = md5_gg(
														i, m = md5_gg(m, f, r, i, d[n + 9], 5, 568446438), f, r,
														d[n + 14], 9, -1019803690,
													), m, f, d[n + 3], 14, -187363961,
												), i, m, d[n + 8], 20, 1163531501,
											), r = md5_gg(
												r, i = md5_gg(
													i, m = md5_gg(m, f, r, i, d[n + 13], 5, -1444681467), f, r,
													d[n + 2], 9, -51403784,
												), m, f, d[n + 7], 14, 1735328473,
											), i, m, d[n + 12], 20, -1926607734,
										), r = md5_hh(
											r, i = md5_hh(
												i, m = md5_hh(m, f, r, i, d[n + 5], 4, -378558), f, r, d[n + 8], 11,
												-2022574463,
											), m, f, d[n + 11], 16, 1839030562,
										), i, m, d[n + 14], 23, -35309556,
									), r = md5_hh(
										r, i = md5_hh(
											i, m = md5_hh(m, f, r, i, d[n + 1], 4, -1530992060), f, r, d[n + 4], 11,
											1272893353,
										), m, f, d[n + 7], 16, -155497632,
									), i, m, d[n + 10], 23, -1094730640,
								), r = md5_hh(
									r, i = md5_hh(
										i, m = md5_hh(m, f, r, i, d[n + 13], 4, 681279174), f, r, d[n], 11, -358537222,
									), m, f, d[n + 3], 16, -722521979,
								), i, m, d[n + 6], 23, 76029189,
							), r = md5_hh(
								r, i = md5_hh(
									i, m = md5_hh(m, f, r, i, d[n + 9], 4, -640364487), f, r, d[n + 12], 11,
									-421815835,
								), m, f, d[n + 15], 16, 530742520,
							), i, m, d[n + 2], 23, -995338651,
						), r = md5_ii(
							r, i = md5_ii(
								i, m = md5_ii(m, f, r, i, d[n], 6, -198630844), f, r, d[n + 7], 10, 1126891415,
							), m, f, d[n + 14], 15, -1416354905,
						), i, m, d[n + 5], 21, -57434055,
					), r = md5_ii(
						r, i = md5_ii(
							i, m = md5_ii(m, f, r, i, d[n + 12], 6, 1700485571), f, r, d[n + 3], 10, -1894986606,
						), m, f, d[n + 10], 15, -1051523,
					), i, m, d[n + 1], 21, -2054922799,
				), r = md5_ii(
					r, i = md5_ii(i, m = md5_ii(m, f, r, i, d[n + 8], 6, 1873313359), f, r, d[n + 15], 10, -30611744),
					m, f, d[n + 6], 15, -1560198380,
				), i, m, d[n + 13], 21, 1309151649,
			), r = md5_ii(
				r, i = md5_ii(i, m = md5_ii(m, f, r, i, d[n + 4], 6, -145523070), f, r, d[n + 11], 10, -1120210379), m,
				f, d[n + 2], 15, 718787259,
...
function bit_rol(d: number, _: number){return d << _ | d >>> 32 - _;}
